...
from src.project import interface_pb2 as src_dot_project_dot_interface__pb2
...
class KeyValueStoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Get = channel.unary_unary(
                ...
                request_serializer=src_dot_project_dot_interface__pb2.KeyRequest.SerializeToString,
                response_deserializer=src_dot_project_dot_interface__pb2.KeyValueVersionReply.FromString,
                )
        self.GetRange = channel.unary_stream(
                '/project.KeyValueStore/GetRange',
                request_serializer=src_dot_project_dot_interface__pb2.KeyRange.SerializeToString,
                response_deserializer=src_dot_project_dot_interface__pb2.KeyValueVersionReply.FromString,
                )
        ...
        self.Put = channel.unary_unary(
                ...
                request_serializer=src_dot_project_dot_interface__pb2.KeyValueRequest.SerializeToString,
                response_deserializer=src_dot_project_dot_interface__pb2.PutReply.FromString,
                )
...
def add_KeyValueStoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Get': grpc.unary_unary_rpc_method_handler(
                    servicer.Get,
                    request_deserializer=src_dot_project_dot_interface__pb2.KeyRequest.FromString,
                    response_serializer=src_dot_project_dot_interface__pb2.KeyValueVersionReply.SerializeToString,
            ),
            'GetRange': grpc.unary_stream_rpc_method_handler(
                    servicer.GetRange,
                    request_deserializer=src_dot_project_dot_interface__pb2.KeyRange.FromString,
                    response_serializer=src_dot_project_dot_interface__pb2.KeyValueVersionReply.SerializeToString,
            ),
            ...
            'Put': grpc.unary_unary_rpc_method_handler(
                    servicer.Put,
                    request_deserializer=src_dot_project_dot_interface__pb2.KeyValueRequest.FromString,
                    response_serializer=src_dot_project_dot_interface__pb2.PutReply.SerializeToString,
            ),
...
class KeyValueStore(object):
    ...
    def Get(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/project.KeyValueStore/Get',
            src_dot_project_dot_interface__pb2.KeyRequest.SerializeToString,
            src_dot_project_dot_interface__pb2.KeyValueVersionReply.FromString,
    ...
    def GetRange(request,
        ...
        return grpc.experimental.unary_stream(request, target, '/project.KeyValueStore/GetRange',
            src_dot_project_dot_interface__pb2.KeyRange.SerializeToString,
            src_dot_project_dot_interface__pb2.KeyValueVersionReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def Put(request,
        ...
        return grpc.experimental.unary_unary(request, target, '/project.KeyValueStore/Put',
            src_dot_project_dot_interface__pb2.KeyValueRequest.SerializeToString,
            src_dot_project_dot_interface__pb2.PutReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
